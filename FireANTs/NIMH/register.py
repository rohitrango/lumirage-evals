'''
another variant where nearest neighbor labels are used instead of one-hot labels
'''
from dataset import NIMHDataset, nimh_collate_fn
...
def main(args):
    dataset = NIMHDataset(json_path=args.json_path, nearest=True)
    dataloader = DataLoader(dataset, batch_size=1, collate_fn=nimh_collate_fn)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--deformable_iterations", type=str, default="200, 100, 50, 20")
    ...
    parser.add_argument("--json_path", type=str, default="/data/rohitrango/code/vfa/vfa/configs/nimh_t1_atropos.json")
